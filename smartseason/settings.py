...
ALLOWED_HOSTS = ['smartseasonbnd.onrender.com', 'localhost', '127.0.0.1', 'smartseasonbnd-4fe5.onrender.com']
...
# 🚀 If a DATABASE_URL is found in the .env or Render, use Supabase (Postgres)
